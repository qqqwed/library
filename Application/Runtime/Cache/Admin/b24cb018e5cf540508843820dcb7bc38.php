...
<div class="page-container">
	<div class="text-c">
		<form class="Huiform" method="post" action="" target="_self">
			...
			<button type="submit" class="btn btn-success" id="" name=""><i class="Hui-iconfont">&#xe665;</i> 查询读者信息</button>
			<div id="result"></div>
		</form>
	</div>
	<div class="info">
	...
	<div class=" pd-5 bg-1 mt-20" style="text-align: center;">
		<div class=" skin-minimal">
			...
			<button type="submit" class="btn btn-success" id="" name=""><i class="Hui-iconfont">&#xe665;</i> 查询图书信息</button>
			<div id="result2"></div>
		</div>
...
<script type="text/javascript">
	...
	function book_borrow(obj,id,reader) {
		layer.confirm('确认要借书吗？',function(){
			$.ajax({
				type: 'POST',
				url : '/index.php/Admin/BookBorrow/bookBorrow',
				traditional:true,
...
<script>
	...
	function bookInfo(key) {
		if(key != ''){
			$.get('/index.php/Admin/BookBorrow/bookInfo/key/'+key,function (msg) {
				if(msg.code != 10000){
...
//                    点击选项,自动填充到搜索框,
	...
	function queryBook(key) {
		$.get('/index.php/Admin/BookBorrow/querybook/key/'+key,function (msg) {
			if(msg.code == 10000){
