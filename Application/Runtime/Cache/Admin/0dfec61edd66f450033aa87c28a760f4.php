...
<head>
    ...
    <script type="text/javascript" src="/Public/Admin/js/jquery.tscookie.js"></script>
    <script type="text/javascript" src="/Public/Admin/js/jquery.validation.min.js"></script>
    <script type="text/javascript" src="/Public/Admin/js/jquery.supersized.min.js" ></script>
    <script type="text/javascript" src="/Public/Admin/js/jquery.progressBar.js"></script>
    <script type="text/javascript" src="/Public/Admin/js/layer/layer.js"></script>
    <script type="text/javascript" src="/Public/Admin/js/login.js"></script>
    <script type="text/javascript">
        var loginHandleUrl = "/index.php?m=Admin&c=Login&a=loginHandle";
        var homeUrl = "/index.php?m=Admin";
    </script>
</head>
<body>
 <!--v3-v12-->
<div class="login-layout">
    ...
    <form method="post" id="form_login">
        <div class="lock-holder">
            ...
            <i id="dot-left" class="fa dot-left Hui-iconfont">&#xe6f9;</i>
            <i id="dot-right" class="fa dot-right Hui-iconfont">&#xe6f9;</i>
        ...
        <div class="avatar"><img src="/Public/Admin/images/admin.png" alt=""></div>
        <div class="submit"> 
            <span>
                <div class="code">
                    <div class="arrow"></div>
                    <div class="code-img">
                        <img src="/index.php?m=Admin&c=Login&a=captcha" name="codeimage" id="codeimage" onclick="verifyimage()" border="0"/>
                    </div>
...
$(function(){
    $.supersized({
        ...
        slides             : [    
            ...
            {image : '/Public/Admin/images/5.jpg'}
        ]
    });
	//显示隐藏验证码
    $("#hide").click(function(){
...
var verifyUrl = "/index.php?m=Admin&c=Login&a=captcha";
